...
wl = FFPOSI[0]                              #确认ASSIGNW从哪里开始取值,这里是从第一个FF之后开始取值
reline= ''
WLL=0
kk = 0
START = 0
...
with open(astresult, 'w', encoding='UTF-8') as astr:
    ...
    ASTver = '{} '.format(" AST parser version is ASTparser_test_assignw4，不打开DLY，Assignw的个数算在里面了")                         #Assignw从FF之后开始算
